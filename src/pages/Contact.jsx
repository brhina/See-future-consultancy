      ...
      <section className="py-16 lg:py-24">
        <div className="mx-auto grid max-w-7xl gap-8 px-4 sm:px-6 lg:grid-cols-2 lg:px-8">
          <div className="rounded-xl border border-gray-200 p-8 shadow-sm">
            <h2 className="mb-6 text-2xl font-bold text-gray-900">Office Location</h2>
          ...
          <div className="rounded-xl border border-gray-200 p-8 shadow-sm">
            <h2 className="mb-4 text-2xl font-bold text-gray-900">Partnership and Project Inquiries</h2>
